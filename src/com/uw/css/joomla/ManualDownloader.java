...
public class ManualDownloader {
    public static String BASE_URL="https://docs.joomla.org";//Starting URL to start scraping
    public static String DOCUMENTATION_DIR="./output/documentation/joomla/"; //Where .txt files go
    ...
    private static void getPackagesList() {
        ...
        try {
            ...
            Elements elements = doc.select("div[class=text-left] a");
    ...
    public static void exportTextContentToTxtFile() throws IOException { //creates .txt files
        ...
        PrintWriter out = new PrintWriter(new FileWriter(DOCUMENTATION_DIR+"joomla!.txt"));
